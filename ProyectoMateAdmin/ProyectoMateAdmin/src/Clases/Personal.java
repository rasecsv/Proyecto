...
public class Personal {
	...
	private int permisosAdmin; 
        ...
        public void Personal(int idPersona,String nombre , String apellidos , int dni, String ruc,boolean cargo,int idarea,int permisosadmin){
    ...
    private void idPersona(int idPersona) {
